...
<head>
	...
	<style>
		...
		.header { width: 96vw; color: white; padding: 20px 30px; display: flex; justify-content: space-between; align-items: center; }
		.header-left { display: flex; align-items: center; }
		.circle { width: 3rem; height: 3rem; background-color: #1d90f5; border-radius: 50%; margin-right: 1rem; }
		.tabs { width: 93%; min-height: 82%; background: linear-gradient(to right, rgb(39,42,55) 40%, rgba(39,42,55,0.8)), url("${pageContext.request.contextPath}/images/bg1.jpg") center no-repeat; background-size: cover; border-radius: 2rem; box-shadow: 0 1rem 5rem rgba(0,0,0,0.4); margin: 0 auto; display: flex; flex-direction: column; padding-bottom: 30px; }
		.tabs h2 { padding-left: 5%; margin-top: 5%; margin-bottom: 20px; font-size: 3em; }
		h3 { padding-left: 5%; font-size: 1.8em; margin-bottom: 15px; color: #1d90f5; }
		.info-section { padding-left: 5%; padding-right: 5%; margin-bottom: 25px; }
		.info-box { background: rgba(255,255,255,0.05); border-left: 4px solid #1d90f5; padding: 20px; border-radius: 8px; margin-bottom: 20px; }
		.info-box h4 { color: #1d90f5; font-size: 1.3em; margin-bottom: 10px; margin-top: 0; }
		.info-box p { margin: 8px 0; font-size: 1.1em; }
		.info-box strong { color: #fff; display: inline-block; min-width: 150px; }
		.status-badge { display: inline-block; padding: 5px 15px; border-radius: 20px; font-weight: bold; font-size: 0.95em; }
		.status-success { background: #4caf50; color: white; }
		table { width: 90%; margin: 20px auto; border-collapse: collapse; border: 2px solid #fff; border-radius: 12px; overflow: hidden; background: rgba(255,255,255,0.05); color: #fff; }
		th,td { border: 1px solid #fff; padding: 15px; text-align: center; }
		th { background-color: rgba(29,144,245,0.3); font-size: 1.1em; font-weight: 600; }
		tr:hover { background-color: rgba(255,255,255,0.1); transition: 0.2s; }
		.product-name { font-weight: bold; color: #1d90f5; }
		.total-row { background-color: rgba(29,144,245,0.2); font-weight: bold; font-size: 1.2em; }
		.total-row td { border-top: 3px solid #1d90f5; }
		.back-link { padding-left: 5%; display: inline-block; margin-top: 20px; margin-bottom: 20px; color: #1d90f5; text-decoration: none; font-size: 1.1em; font-weight: 600; }
		.back-link:hover { color: #00b7ff; text-decoration: underline; }
		.error-message { padding-left: 5%; padding-right: 5%; color: #ff6b6b; font-weight: bold; margin: 20px 0; font-size: 1.2em; }
