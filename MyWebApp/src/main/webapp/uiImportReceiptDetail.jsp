    ...
    <div class="tabs">
        ...
        <c:if test="${not empty importReceipt}">
            <div class="info-section">
                ...
                <div class="info-box">
                    ...
                    <p><strong>Total Value:</strong> 
                        <fmt:formatNumber value="${importReceipt.totalValue}" type="currency" currencyCode="VND" />
                    </p>
                        ...
                        <c:forEach var="detail" items="${importDetails}" varStatus="status">
                            <tr>
                                ...
                                <td class="number-cell">
                                    <fmt:formatNumber value="${detail.importPrice}" type="currency" currencyCode="VND" />
                                </td>
                                <td class="number-cell">
            ...
            <c:if test="${empty importDetails}">
                <div class="error-message">
                    No product details found for this import receipt.
                </div>
            </c:if>
        </c:if>
